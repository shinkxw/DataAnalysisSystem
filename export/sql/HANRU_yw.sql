...
if exists (select 1 from  sysobjects where  id = object_id('EDU_JPXT_03_02_XYKSQK')
            and   type = 'U')
   drop table EDU_JPXT_03_02_XYKSQK
go
...
--学员考试情况表
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[EDU_JPXT_03_02_XYKSQK]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EDU_JPXT_03_02_XYKSQK](
	[XYID]  int  NOT NULL,--学员ID
	[SCHOOLID]  int  NOT NULL,--学校ID
	[KMYIKSSJ]  datetime  NOT NULL,--科目一考试时间
	[KMYIKSJG]  int  NOT NULL,--科目一考试结果
	[KMERKSSJ]  datetime  NOT NULL,--科目二考试时间
	[KMERYKSJG]  int  NOT NULL,--科目二考试结果
	[KMSANKSSJ]  datetime  NOT NULL,--科目三考试时间
	[KMSANKSJG]  int  NOT NULL,--科目三考试结果
	[KMSIKSSJ]  datetime  NOT NULL,--科目四考试时间
	[KMSIKSJG]  int  NOT NULL,--科目四考试结果
	[KMWUKSSJ]  datetime  NOT NULL,--科目五考试时间
	[KMWUKSJG]  int  NOT NULL,--科目五考试结果
CONSTRAINT [PK_EDU_JPXT_03_02_XYKSQK] PRIMARY KEY CLUSTERED
(
	[XYID] ASC,
	[SCHOOLID] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'学员考试情况表' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'学员ID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'XYID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'学校ID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'SCHOOLID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目一考试时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMYIKSSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目一考试结果' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMYIKSJG'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目二考试时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMERKSSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目二考试结果' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMERYKSJG'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目三考试时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMSANKSSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目三考试结果' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMSANKSJG'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目四考试时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMSIKSSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目四考试结果' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMSIKSJG'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目五考试时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMWUKSSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'科目五考试结果' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_JPXT_03_02_XYKSQK', @level2type=N'COLUMN',@level2name=N'KMWUKSJG'
GO
