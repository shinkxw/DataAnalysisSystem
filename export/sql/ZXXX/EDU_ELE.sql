...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'当前学年学期配置表' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ELE_01_SCHOOL'
GO
