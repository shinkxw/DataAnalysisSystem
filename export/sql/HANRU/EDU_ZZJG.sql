...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'评教时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZZJG_20_A07_XSPJKPJG', @level2type=N'COLUMN',@level2name=N'PJSJ'
GO
