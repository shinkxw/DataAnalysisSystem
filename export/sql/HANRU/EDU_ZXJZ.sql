...
if exists (select 1 from  sysobjects where  id = object_id('EDU_ZXJZ_01_A07_JZGLX')
            and   type = 'U')
   drop table EDU_ZXJZ_01_A07_JZGLX
go
...
if exists (select 1 from  sysobjects where  id = object_id('EDU_ZXJZ_20_A09_XSPJPJ')
            and   type = 'U')
   drop table EDU_ZXJZ_20_A09_XSPJPJ
go
...
CREATE TABLE [dbo].[EDU_ZXJZ_01_01_JZGJBSJ](
	...
	[XQ]  nvarchar(200)  NULL,--校区
	[ZGZC]  nvarchar(200)  NULL,--最高职称
	[PDSJ]  nvarchar(200)  NULL,--评定时间
	[XPZC]  nvarchar(200)  NULL,--现品职称
	[PDESJ]  nvarchar(200)  NULL,--聘得时间
	[RBXQDW]  nvarchar(200)  NULL,--入本校前单位
	[ZZZT]  nvarchar(200)  NULL,--在职状态
	[SZBM]  nvarchar(200)  NULL,--所在部门
	[XZZW]  nvarchar(200)  NULL,--行政职务
	[DH]  nvarchar(200)  NULL,--短号
	[PTHDJ]  nvarchar(200)  NULL,--普通话等级
	[JSZH]  nvarchar(200)  NULL,--教师证号
	[JSJDJ]  nvarchar(200)  NULL,--计算机等级
	[GGJSDJ]  nvarchar(200)  NULL,--骨干教师等级
	[RJXK]  nvarchar(200)  NULL,--任教学科
	[SFRSDL]  nvarchar(200)  NULL,--是否人事代理
	[NDKH]  text  NULL,--年度考核
	[XXJL]  text  NULL,--学习经历
	[GZJL]  text  NULL,--工作经历
	[JYQK]  text  NULL,--教研情况
	[GZYLJCQK]  text  NULL,--工作以来奖惩情况
	[JTZYCY]  text  NULL,--家庭主要成员
	[BZ]  text  NULL,--备注
	[DYXLCD]  nvarchar(200)  NULL,--第一学历程度
	[DYXLFS]  nvarchar(200)  NULL,--第一学历方式
	[DYXLXZ]  nvarchar(200)  NULL,--第一学历学制
	[DYXLXW]  nvarchar(200)  NULL,--第一学历学位
	[DYXLBYSJ]  nvarchar(200)  NULL,--第一学历毕业时间
	[DYXLBYXX]  nvarchar(200)  NULL,--第一学历毕业学校
	[DYXLZY]  nvarchar(200)  NULL,--第一学历专业
	[ZGXLCD]  nvarchar(200)  NULL,--最高学历程度
	[ZGXLFS]  nvarchar(200)  NULL,--最高学历方式
	[ZGXLXZ]  nvarchar(200)  NULL,--最高学历学制
	[ZGXLXW]  nvarchar(200)  NULL,--最高学历学位
	[ZGXLBYSJ]  nvarchar(200)  NULL,--最高学历毕业时间
	[ZGXLBYXX]  nvarchar(200)  NULL,--最高学历毕业学校
	[ZGXLZY]  nvarchar(200)  NULL,--最高学历专业
...
--教职工类型表
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[EDU_ZXJZ_01_A07_JZGLX]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EDU_ZXJZ_01_A07_JZGLX](
	[ID]  int  NOT NULL,--编号
	[SCHOOLID]  int  NOT NULL,--学校
	[LXMC]  nvarchar(60)  NULL,--类型名称
CONSTRAINT [PK_EDU_ZXJZ_01_A07_JZGLX] PRIMARY KEY CLUSTERED
(
	[ID] ASC,
	[SCHOOLID] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
...
CREATE TABLE [dbo].[EDU_ZXJZ_20_A04_XSPJKP](
	...
	[KSSJ]  datetime  NOT NULL,--开始时间
	[JSSJ]  datetime  NOT NULL,--结束时间
	[SFXYWBPJ]  int  NOT NULL,--是否需要文本评教
	[ZT]  int  NOT NULL,--状态
...
--学生评教评价表
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[EDU_ZXJZ_20_A09_XSPJPJ]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EDU_ZXJZ_20_A09_XSPJPJ](
	[ID]  int  identity,--编号
	[SCHOOLID]  int  NOT NULL,--学校
	[KPBJID]  int  NOT NULL,--考评班级ID
	[JZGJBSJID]  int  NOT NULL,--教职工ID
...
CONSTRAINT [PK_EDU_ZXJZ_20_A09_XSPJPJ] PRIMARY KEY CLUSTERED
(
	[ID] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'教职工类型ID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'JZGLXID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'校区' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'XQ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高职称' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZGZC'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'评定时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'PDSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'现品职称' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'XPZC'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'聘得时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'PDESJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'入本校前单位' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'RBXQDW'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'在职状态' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZZZT'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'所在部门' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'SZBM'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'行政职务' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'XZZW'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'短号' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'DH'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'普通话等级' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'PTHDJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'教师证号' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'JSZH'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'计算机等级' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'JSJDJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'骨干教师等级' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'GGJSDJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'任教学科' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'RJXK'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'是否人事代理' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'SFRSDL'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'年度考核' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'NDKH'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'学习经历' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'XXJL'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'工作经历' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'GZJL'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'教研情况' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'JYQK'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'工作以来奖惩情况' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'GZYLJCQK'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'家庭主要成员' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'JTZYCY'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'备注' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'BZ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历程度' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'DYXLCD'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历方式' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'DYXLFS'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历学制' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'DYXLXZ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历学位' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'DYXLXW'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历毕业时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'DYXLBYSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历毕业学校' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'DYXLBYXX'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历专业' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'DYXLZY'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历程度' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZGXLCD'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历方式' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZGXLFS'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历学制' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZGXLXZ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历学位' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZGXLXW'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历毕业时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZGXLBYSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历毕业学校' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZGXLBYXX'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历专业' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_01_JZGJBSJ', @level2type=N'COLUMN',@level2name=N'ZGXLZY'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'校区' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'XQ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高职称' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZGZC'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'评定时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'PDSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'现品职称' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'XPZC'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'聘得时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'PDESJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'入本校前单位' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'RBXQDW'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'在职状态' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZZZT'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'所在部门' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'SZBM'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'行政职务' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'XZZW'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'短号' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'DH'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'普通话等级' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'PTHDJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'教师证号' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'JSZH'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'计算机等级' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'JSJDJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'骨干教师等级' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'GGJSDJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'任教学科' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'RJXK'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'是否人事代理' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'SFRSDL'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'年度考核' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'NDKH'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'学习经历' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'XXJL'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'工作经历' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'GZJL'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'教研情况' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'JYQK'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'工作以来奖惩情况' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'GZYLJCQK'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'家庭主要成员' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'JTZYCY'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'备注' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'BZ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历程度' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'DYXLCD'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历方式' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'DYXLFS'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历学制' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'DYXLXZ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历学位' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'DYXLXW'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历毕业时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'DYXLBYSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历毕业学校' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'DYXLBYXX'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'第一学历专业' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'DYXLZY'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历程度' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZGXLCD'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历方式' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZGXLFS'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历学制' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZGXLXZ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历学位' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZGXLXW'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历毕业时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZGXLBYSJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历毕业学校' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZGXLBYXX'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最高学历专业' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A04_JZGJBSJSH', @level2type=N'COLUMN',@level2name=N'ZGXLZY'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'教职工类型表' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A07_JZGLX'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'编号' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A07_JZGLX', @level2type=N'COLUMN',@level2name=N'ID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'学校' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A07_JZGLX', @level2type=N'COLUMN',@level2name=N'SCHOOLID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'类型名称' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_01_A07_JZGLX', @level2type=N'COLUMN',@level2name=N'LXMC'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'是否需要文本评教' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_20_A04_XSPJKP', @level2type=N'COLUMN',@level2name=N'SFXYWBPJ'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'学生评教评价表' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_20_A09_XSPJPJ'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'编号' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_20_A09_XSPJPJ', @level2type=N'COLUMN',@level2name=N'ID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'学校' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_20_A09_XSPJPJ', @level2type=N'COLUMN',@level2name=N'SCHOOLID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'考评班级ID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_20_A09_XSPJPJ', @level2type=N'COLUMN',@level2name=N'KPBJID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'教职工ID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_20_A09_XSPJPJ', @level2type=N'COLUMN',@level2name=N'JZGJBSJID'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'IP地址' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_20_A09_XSPJPJ', @level2type=N'COLUMN',@level2name=N'IP'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'评价内容' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZXJZ_20_A09_XSPJPJ', @level2type=N'COLUMN',@level2name=N'PJNR'
GO
