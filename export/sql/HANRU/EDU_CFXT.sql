...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'结果' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_CFXT_01_A03_CKXS', @level2type=N'COLUMN',@level2name=N'JG'
GO
