...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'接收人类别' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'EDU_ZZBG_11_A01_YJ', @level2type=N'COLUMN',@level2name=N'JSRLB'
GO
