...
--用餐登记表
CREATE VIEW [dbo].[VIEW_EDU_ZXXX_10_A02_YCDJ_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校
      ,a.[XSID]--学生ID
...
FROM dbo.EDU_ZXXX_10_A02_YCDJ AS a LEFT OUTER JOIN
      dbo.EDU_ZXXS_01_01_XSXX AS c ON a.XSID = c.ID /*学生ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZXXX_10_A01_SCSZ AS d ON a.SCID = d.ID /*三餐ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFBZ AS e ON a.SFJC = e.DM /*是否就餐*/ LEFT OUTER JOIN
