...
--资源目录审核权限表
CREATE VIEW [dbo].[VIEW_EDU_ZYZX_01_A02_ZYMLSHQX_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校
      ,a.[YHID]--用户ID
...
FROM dbo.EDU_ZYZX_01_A02_ZYMLSHQX AS a LEFT OUTER JOIN
      dbo.EDU_ELE_01_USER AS c ON a.YHID = c.LOGINNAME /*用户ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校*/
GO
