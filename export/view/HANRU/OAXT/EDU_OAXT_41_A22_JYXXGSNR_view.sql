...
--教研信息公示内容表
CREATE VIEW [dbo].[VIEW_EDU_OAXT_41_A22_JYXXGSNR_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[LBID]--类别ID
      ...
      ,a.[BT]--标题
      ,a.[NR]--内容
      ,c.SCHOOLID as c_JYXXGSLB_SCHOOLID--教研信息公示类别表 学校ID
      ,c.LBMC as c_JYXXGSLB_LBMC--教研信息公示类别表 类别名称
...
FROM dbo.EDU_OAXT_41_A22_JYXXGSNR AS a LEFT OUTER JOIN
      dbo.EDU_OAXT_41_A21_JYXXGSLB AS c ON a.LBID = c.ID /*类别ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
