...
--附加字段表
CREATE VIEW [dbo].[VIEW_EDU_OAXT_50_A16_FJZD_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[XMID]--项目ID
...
FROM dbo.EDU_OAXT_50_A16_FJZD AS a LEFT OUTER JOIN
      ...
      dbo.EDU_OAXT_50_A12_DFJD AS d ON a.DFJDID = d.ID /*打分节点ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校ID*/ AND a.XMID = d.XMID /*项目ID*/
GO
