...
--学校公告内容表
CREATE VIEW [dbo].[VIEW_EDU_OAXT_41_A42_XXGGNR_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[LBID]--类别ID
...
FROM dbo.EDU_OAXT_41_A42_XXGGNR AS a LEFT OUTER JOIN
      dbo.EDU_OAXT_41_A41_XXGGLB AS c ON a.LBID = c.ID /*类别ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
