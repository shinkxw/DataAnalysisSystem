...
--每周礼仪公示内容表
CREATE VIEW [dbo].[VIEW_EDU_OAXT_41_A32_MZLYGSNR_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[LBID]--类别ID
      ...
      ,a.[BT]--标题
      ,a.[NR]--内容
      ,c.SCHOOLID as c_MZLYGSLB_SCHOOLID--每周礼仪公示类别表 学校ID
      ,c.LBMC as c_MZLYGSLB_LBMC--每周礼仪公示类别表 类别名称
...
FROM dbo.EDU_OAXT_41_A32_MZLYGSNR AS a LEFT OUTER JOIN
      dbo.EDU_OAXT_41_A31_MZLYGSLB AS c ON a.LBID = c.ID /*类别ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
