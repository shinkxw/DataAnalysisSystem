...
FROM dbo.EDU_ZZJX_50_A03_JXBSJ AS a LEFT OUTER JOIN
      ...
      dbo.EDU_ZZJG_01_01_JZGJBSJ AS f ON a.KKJSID = f.ID /*开课教师ID*/ AND a.SCHOOLID = f.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZZJX_50_A02_KKSJ AS g ON a.SKSJID = g.ID /*上课时间ID*/ LEFT OUTER JOIN
