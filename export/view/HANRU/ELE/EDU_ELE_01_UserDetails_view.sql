...
--系统用户详情表
CREATE VIEW [dbo].[VIEW_EDU_ELE_01_UserDetails_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[LoginName]--用户ID
...
FROM dbo.EDU_ELE_01_UserDetails AS a LEFT OUTER JOIN
      dbo.EDU_ELE_01_USER AS c ON a.LoginName = c.LOGINNAME /*用户ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校ID*/
GO
