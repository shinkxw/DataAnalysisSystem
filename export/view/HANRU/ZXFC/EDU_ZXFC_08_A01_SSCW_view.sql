...
--宿舍床位表
CREATE VIEW [dbo].[VIEW_EDU_ZXFC_08_A01_SSCW_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[SSLID]--宿舍楼ID
...
FROM dbo.EDU_ZXFC_08_A01_SSCW AS a LEFT OUTER JOIN
      dbo.EDU_ZXFC_02_01_JZWJBSJ AS c ON a.SSLID = c.ID /*宿舍楼ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_ZXFC_08_01_XSSS AS d ON a.SSID = d.ID /*宿舍ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
