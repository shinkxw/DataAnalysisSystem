...
--学生宿舍数据类表
CREATE VIEW [dbo].[VIEW_EDU_ZXFC_08_01_XSSS_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校名
      ,a.[SSLID]--宿舍楼ID
...
FROM dbo.EDU_ZXFC_08_01_XSSS AS a LEFT OUTER JOIN
      dbo.EDU_ZXFC_02_01_JZWJBSJ AS c ON a.SSLID = c.ID /*宿舍楼ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校名*/ LEFT OUTER JOIN
