...
--学生综合素质评价结果表
CREATE VIEW [dbo].[VIEW_EDU_ZXXS_56_A32_XSZHSZPJJG_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校
      ,a.[XQID]--学期ID
      ...
      ,e.GJBX as e_XSZHSZPJXM_GJBX--学生综合素质评价项目表 关键表现
      ,e.ZWPDDFFSID as e_XSZHSZPJXM_ZWPDDFFSID--学生综合素质评价项目表 自我评定打分方式ID
      ,e.XZPDDFFSID as e_XSZHSZPJXM_XZPDDFFSID--学生综合素质评价项目表 小组评定打分方式ID
      ,e.PLSX as e_XSZHSZPJXM_PLSX--学生综合素质评价项目表 排列顺序
...
FROM dbo.EDU_ZXXS_56_A32_XSZHSZPJJG AS a LEFT OUTER JOIN
      dbo.EDU_ELE_01_XQ AS c ON a.XQID = c.ID /*学期ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZXXS_01_01_XSXX AS d ON a.BPXSID = d.ID /*被评学生ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZXXS_56_A31_XSZHSZPJXM AS e ON a.PJXMID = e.ID /*评价项目ID*/ AND a.SCHOOLID = e.SCHOOLID /*学校*/ LEFT OUTER JOIN
