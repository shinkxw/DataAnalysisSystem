...
SELECT a.[ID]--编号
      ...
      ,e.SCHOOLID as e_DSZJS_SCHOOLID--导师制角色表 学校
      ,e.XQID as e_DSZJS_XQID--导师制角色表 学期ID
...
FROM dbo.EDU_ZXXS_57_A03_DSZDS AS a LEFT OUTER JOIN
      ...
      dbo.EDU_ZXXS_57_A02_DSZJS AS e ON a.JUESEID = e.ID /*角色ID*/ AND a.SCHOOLID = e.SCHOOLID /*学校*/ LEFT OUTER JOIN
