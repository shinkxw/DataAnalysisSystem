...
--导师结对导师表
CREATE VIEW [dbo].[VIEW_EDU_ZXXS_58_A02_DSJDDS_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校
      ,a.[JSID]--教师ID
...
FROM dbo.EDU_ZXXS_58_A02_DSJDDS AS a LEFT OUTER JOIN
      dbo.EDU_ZXJZ_01_01_JZGJBSJ AS c ON a.JSID = c.ID /*教师ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校*/ LEFT OUTER JOIN
