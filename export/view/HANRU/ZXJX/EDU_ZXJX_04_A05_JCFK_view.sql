...
--教材反馈表
CREATE VIEW [dbo].[VIEW_EDU_ZXJX_04_A05_JCFK_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[XQID]--学期ID
...
FROM dbo.EDU_ZXJX_04_A05_JCFK AS a LEFT OUTER JOIN
      ...
      dbo.EDU_ZXJZ_01_01_JZGJBSJ AS e ON a.FKJSID = e.ID /*反馈教师ID*/ AND a.SCHOOLID = e.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
