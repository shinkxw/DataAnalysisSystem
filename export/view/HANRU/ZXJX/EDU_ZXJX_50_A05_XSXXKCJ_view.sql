...
--学生选修课成绩表
CREATE VIEW [dbo].[VIEW_EDU_ZXJX_50_A05_XSXXKCJ_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校
      ,a.[XSID]--学生ID
      ...
      ,d.NJID as d_JXBSJ_NJID--教学班数据表 年级ID
...
FROM dbo.EDU_ZXJX_50_A05_XSXXKCJ AS a LEFT OUTER JOIN
      dbo.EDU_ZXXS_01_01_XSXX AS c ON a.XSID = c.ID /*学生ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZXJX_50_A03_JXBSJ AS d ON a.JXBID = d.ID /*教学班ID*/ LEFT OUTER JOIN
