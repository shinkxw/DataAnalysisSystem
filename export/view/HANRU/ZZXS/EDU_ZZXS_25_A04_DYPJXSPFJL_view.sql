...
SELECT a.[ID]--编号
      ...
      ,i.SCHOOLID as i_DYPJBJPFJL_SCHOOLID--德育评价班级评分记录表 学校
      ,i.XQID as i_DYPJBJPFJL_XQID--德育评价班级评分记录表 学期ID
      ,i.ZCID as i_DYPJBJPFJL_ZCID--德育评价班级评分记录表 周次ID
      ,i.JSID as i_DYPJBJPFJL_JSID--德育评价班级评分记录表 教师ID
      ,i.BJID as i_DYPJBJPFJL_BJID--德育评价班级评分记录表 班级ID
      ,i.DLID as i_DYPJBJPFJL_DLID--德育评价班级评分记录表 大类ID
      ,i.XLID as i_DYPJBJPFJL_XLID--德育评价班级评分记录表 小类ID
      ,i.SJ as i_DYPJBJPFJL_SJ--德育评价班级评分记录表 时间
      ,i.FZ as i_DYPJBJPFJL_FZ--德育评价班级评分记录表 分值
      ,i.BZ as i_DYPJBJPFJL_BZ--德育评价班级评分记录表 备注
      ,i.ZT as i_DYPJBJPFJL_ZT--德育评价班级评分记录表 状态
      ,i.TJSJ as i_DYPJBJPFJL_TJSJ--德育评价班级评分记录表 添加时间
      ,i.XFSQJSID as i_DYPJBJPFJL_XFSQJSID--德育评价班级评分记录表 销分申请教师ID
      ,i.XFSQSJ as i_DYPJBJPFJL_XFSQSJ--德育评价班级评分记录表 销分申请时间
      ,i.XFLY as i_DYPJBJPFJL_XFLY--德育评价班级评分记录表 销分理由
      ,i.XFCLJSID as i_DYPJBJPFJL_XFCLJSID--德育评价班级评分记录表 销分处理教师ID
      ,i.XFCLSJ as i_DYPJBJPFJL_XFCLSJ--德育评价班级评分记录表 销分处理时间
      ,i.CLYJ as i_DYPJBJPFJL_CLYJ--德育评价班级评分记录表 处理意见
      ,i.SCZT as i_DYPJBJPFJL_SCZT--德育评价班级评分记录表 删除状态
      ,i.SCJSID as i_DYPJBJPFJL_SCJSID--德育评价班级评分记录表 删除教师ID
      ,i.SCSJ as i_DYPJBJPFJL_SCSJ--德育评价班级评分记录表 删除时间
...
FROM dbo.EDU_ZZXS_25_A04_DYPJXSPFJL AS a LEFT OUTER JOIN
      ...
      dbo.EDU_ZZXS_25_A03_DYPJBJPFJL AS i ON a.GLBJPFJLID = i.ID /*关联班级评分记录ID*/ AND a.SCHOOLID = i.SCHOOLID /*学校*/ LEFT OUTER JOIN
