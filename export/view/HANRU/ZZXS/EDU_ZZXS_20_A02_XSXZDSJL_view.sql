...
--学生选择导师记录表
CREATE VIEW [dbo].[VIEW_EDU_ZZXS_20_A02_XSXZDSJL_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校
      ,a.[DSID]--导师ID
      ,a.[XSID]--学生ID
      ,c.SCHOOLID as c_DSSJ_SCHOOLID--导师数据表 学校
      ...
      ,c.ZDXXZRS as c_DSSJ_ZDXXZRS--导师数据表 最低需选择人数
...
FROM dbo.EDU_ZZXS_20_A02_XSXZDSJL AS a LEFT OUTER JOIN
      dbo.EDU_ZZXS_20_A01_DSSJ AS c ON a.DSID = c.ID /*导师ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校*/ LEFT OUTER JOIN
