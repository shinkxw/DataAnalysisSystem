...
SELECT a.[ID]--编号
      ...
      ,n.PersonalCard1 as n_JZGJBSJ_PersonalCard1--教职工基本数据子类表 个人卡1
      ,n.PersonalCard2 as n_JZGJBSJ_PersonalCard2--教职工基本数据子类表 个人卡2
      ,n.PersonalCard3 as n_JZGJBSJ_PersonalCard3--教职工基本数据子类表 个人卡3
