...
--学生评教评价表
CREATE VIEW [dbo].[VIEW_EDU_ZXJZ_20_A09_XSPJPJ_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校
      ,a.[KPBJID]--考评班级ID
      ...
      ,a.[IP]--IP地址
      ,a.[PJNR]--评价内容
      ,c.SCHOOLID as c_XSPJKPBJ_SCHOOLID--学生评教考评班级表 学校
      ,c.KPID as c_XSPJKPBJ_KPID--学生评教考评班级表 考评ID
      ,c.BJMC as c_XSPJKPBJ_BJMC--学生评教考评班级表 班级名称
      ,c.BPJGIDLB as c_XSPJKPBJ_BPJGIDLB--学生评教考评班级表 被评教工ID列表
      ,c.BPJGXMLB as c_XSPJKPBJ_BPJGXMLB--学生评教考评班级表 被评教工姓名列表
      ,c.DYKCMCLB as c_XSPJKPBJ_DYKCMCLB--学生评教考评班级表 对应课程名称列表
      ,c.YPRS as c_XSPJKPBJ_YPRS--学生评教考评班级表 应评人数
      ,c.SBM as c_XSPJKPBJ_SBM--学生评教考评班级表 识别码
      ,c.KQSJ as c_XSPJKPBJ_KQSJ--学生评教考评班级表 开启时间
      ,c.ZDGBSJ as c_XSPJKPBJ_ZDGBSJ--学生评教考评班级表 自动关闭时间
      ,c.ZT as c_XSPJKPBJ_ZT--学生评教考评班级表 状态
...
FROM dbo.EDU_ZXJZ_20_A09_XSPJPJ AS a LEFT OUTER JOIN
      dbo.EDU_ZXJZ_20_A06_XSPJKPBJ AS c ON a.KPBJID = c.ID /*考评班级ID*/ LEFT OUTER JOIN
      dbo.EDU_ZXJZ_01_01_JZGJBSJ AS d ON a.JZGJBSJID = d.ID /*教职工ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校*/ LEFT OUTER JOIN
