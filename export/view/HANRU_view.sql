...
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZFC_10_A04_YDKHPB_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZFC_10_A04_YDKHPB_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZFC_10_A06_YDKHDD_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZFC_10_A06_YDKHDD_DISP
GO
...
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJG_16_A01_ZPGWSJ_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJG_16_A01_ZPGWSJ_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJG_16_A02_YPJSSJ_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJG_16_A02_YPJSSJ_DISP
GO
...
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_04_01_JCJBXX_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_04_01_JCJBXX_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_04_02_JCXYXX_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_04_02_JCXYXX_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_04_A03_JSJCLY_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_04_A03_JSJCLY_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_04_A04_XSJCLY_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_04_A04_XSJCLY_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_04_A05_JCFK_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_04_A05_JCFK_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_04_A06_JCBF_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_04_A06_JCBF_DISP
GO
...
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_33_A01_YJAP_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_33_A01_YJAP_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_34_A01_XSKCXF_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_34_A01_XSKCXF_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZJX_35_A02_GKKSQ_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZJX_35_A02_GKKSQ_DISP
GO
...
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_10_A12_XSHJXJ_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_10_A12_XSHJXJ_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_10_A13_XSHZXJ_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_10_A13_XSHZXJ_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_11_01_BYSJ_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_11_01_BYSJ_DISP
GO
...
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_18_A02_CFLX_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_18_A02_CFLX_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_18_A03_JCCFBZ_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_18_A03_JCCFBZ_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_18_A04_XSCFXX_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_18_A04_XSCFXX_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_18_A05_JCCFSQ_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_18_A05_JCCFSQ_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_18_A06_JCCFSQSHJL_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_18_A06_JCCFSQSHJL_DISP
GO
if exists (select 1 from  sysobjects where  id = object_id('VIEW_EDU_ZZXS_19_A02_BWCY_DISP')
            and   type = 'V')
   drop view VIEW_EDU_ZZXS_19_A02_BWCY_DISP
GO
...
--教材报废表
CREATE VIEW [dbo].[VIEW_EDU_ZZJX_04_A06_JCBF_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[XQID]--学期ID
...
FROM dbo.EDU_ZZJX_04_A06_JCBF AS a LEFT OUTER JOIN
      dbo.EDU_ELE_01_XQ AS c ON a.XQID = c.ID /*学期ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_ZZJX_04_01_JCJBXX AS d ON a.JCID = d.ID /*教材ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_ZZJG_01_01_JZGJBSJ AS e ON a.JSRID = e.ID /*经手人ID*/ AND a.SCHOOLID = e.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_JY_XQ AS [cb] ON c.XQM = [cb].DM /*学期码*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFBZ AS [db] ON d.SFYLXC = [db].DM /*是否有练习册*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFBZ AS [dc] ON d.SFYJCJF = [dc].DM /*是否有教参教辅*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFZJLX AS [eb] ON e.SFZJLXM = [eb].DM /*身份证件类型码*/ LEFT OUTER JOIN
...
SELECT a.[ID]--编号
      ...
      ,[kb].MC as k_JXJHKCQD_SFHXKC_MC--授课方式代码表 名称
...
FROM dbo.EDU_ZZJX_33_A01_YJAP AS a LEFT OUTER JOIN
      ...
      dbo.EDU_JY_SKFS AS [kb] ON k.SFHXKC = [kb].DM /*是否核心（骨干）*/ LEFT OUTER JOIN
...
SELECT a.[ID]--编号
      ...
      ,[hb].MC as h_JXJHKCQD_SFHXKC_MC--授课方式代码表 名称
...
FROM dbo.EDU_ZZJX_34_A01_XSKCXF AS a LEFT OUTER JOIN
      ...
      dbo.EDU_JY_SKFS AS [hb] ON h.SFHXKC = [hb].DM /*是否核心（骨干）*/ LEFT OUTER JOIN
...
--学生获助学金表
CREATE VIEW [dbo].[VIEW_EDU_ZZXS_10_A13_XSHZXJ_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校ID
      ,a.[XQID]--学期ID
      ...
      ,e.ZZDWHGR as e_ZXJSJ_ZZDWHGR--助学金数据子类表 资助单位或个人
...
FROM dbo.EDU_ZZXS_10_A13_XSHZXJ AS a LEFT OUTER JOIN
      dbo.EDU_ELE_01_XQ AS c ON a.XQID = c.ID /*学期ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_ZZXS_01_01_XSXX AS d ON a.XSXXID = d.ID /*学生ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_ZZXS_10_03_ZXJSJ AS e ON a.ZXJID = e.ID /*助学金ID*/ AND a.SCHOOLID = e.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_ZZJG_01_01_JZGJBSJ AS f ON a.SHJSID = f.ID /*审核教师ID*/ AND a.SCHOOLID = f.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_ZZJG_01_01_JZGJBSJ AS g ON a.TJJSID = g.ID /*添加教师ID*/ AND a.SCHOOLID = g.SCHOOLID /*学校ID*/ LEFT OUTER JOIN
      dbo.EDU_JY_XQ AS [cb] ON c.XQM = [cb].DM /*学期码*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFZJLX AS [db] ON d.SFZJLXM = [db].DM /*身份证件类型码*/ LEFT OUTER JOIN
      ...
      dbo.EDU_JY_SFBZ AS [dn] ON d.SFSLDRK = [dn].DM /*是否是流动人口*/ LEFT OUTER JOIN
      dbo.EDU_GB_SJGGHDQMC AS [do] ON d.GJDQM = [do].DM /*国籍/地区*/ LEFT OUTER JOIN
      dbo.EDU_ZZ_ZXJFL AS [eb] ON e.ZXJLX = [eb].DM /*助学金类型*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFZJLX AS [fb] ON f.SFZJLXM = [fb].DM /*身份证件类型码*/ LEFT OUTER JOIN
      dbo.EDU_GB_RDXB AS [fc] ON f.XBM = [fc].DM /*性别码*/ LEFT OUTER JOIN
      dbo.EDU_GB_ZGGMZMCDLMZMPXF AS [fd] ON f.MZM = [fd].DM /*民族码*/ LEFT OUTER JOIN
      dbo.EDU_JY_XX AS [fe] ON f.XXM = [fe].DM /*血型码*/ LEFT OUTER JOIN
...
--毕业数据表
CREATE VIEW [dbo].[VIEW_EDU_ZZXS_11_01_BYSJ_DISP]
AS
SELECT a.[ID]--编号
      ,a.[SCHOOLID]--学校
      ,a.[XQID]--学期ID
...
FROM dbo.EDU_ZZXS_11_01_BYSJ AS a LEFT OUTER JOIN
      ...
      dbo.EDU_GB_JYPXJG AS e ON a.JSXYM = e.DM /*结束学业码*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFBZ AS f ON a.SFZSLQ = f.DM /*是否证书领取*/ LEFT OUTER JOIN
      dbo.EDU_ZZJG_01_01_JZGJBSJ AS g ON a.TJJSID = g.ID /*添加教师ID*/ AND a.SCHOOLID = g.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZZJG_01_01_JZGJBSJ AS h ON a.SHJSID = h.ID /*审核教师ID*/ AND a.SCHOOLID = h.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_JY_XQ AS [cb] ON c.XQM = [cb].DM /*学期码*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFZJLX AS [db] ON d.SFZJLXM = [db].DM /*身份证件类型码*/ LEFT OUTER JOIN
      dbo.EDU_GB_RDXB AS [dc] ON d.XBM = [dc].DM /*性别码*/ LEFT OUTER JOIN
      dbo.EDU_JY_XX AS [dd] ON d.XXM = [dd].DM /*血型码*/ LEFT OUTER JOIN
...
FROM dbo.EDU_ZZXS_17_A01_TYXX AS a LEFT OUTER JOIN
      dbo.EDU_ZZJX_02_02_ZZBJ AS c ON a.BJID = c.XZBDM /*班级ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZZXS_01_01_XSXX AS d ON a.XSXXID = d.ID /*学生ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZZJG_01_01_JZGJBSJ AS e ON a.JBJSID = e.ID /*经办教师ID*/ AND a.SCHOOLID = e.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFZJLX AS [db] ON d.SFZJLXM = [db].DM /*身份证件类型码*/ LEFT OUTER JOIN
      dbo.EDU_GB_RDXB AS [dc] ON d.XBM = [dc].DM /*性别码*/ LEFT OUTER JOIN
      dbo.EDU_JY_XX AS [dd] ON d.XXM = [dd].DM /*血型码*/ LEFT OUTER JOIN
      dbo.EDU_GB_ZHRMGHGXZQH AS [de] ON d.CSDM = [de].DM /*出生地码*/ LEFT OUTER JOIN
...
SELECT a.[ID]--编号
      ...
      ,e.RTSJ as e_TYXX_RTSJ--团员信息扩展表 入团时间
      ,e.ZRD as e_TYXX_ZRD--团员信息扩展表 转入地
      ,e.ZRSJ as e_TYXX_ZRSJ--团员信息扩展表 转入时间
      ,e.ZCSJ as e_TYXX_ZCSJ--团员信息扩展表 转出时间
      ,e.DQZT as e_TYXX_DQZT--团员信息扩展表 当前状态
      ,e.JBJSID as e_TYXX_JBJSID--团员信息扩展表 经办教师ID
      ,e.BZ as e_TYXX_BZ--团员信息扩展表 备注

FROM dbo.EDU_ZZXS_17_A02_TFSJJL AS a LEFT OUTER JOIN
      dbo.EDU_ELE_01_XQ AS c ON a.XQID = c.ID /*学期ID*/ AND a.SCHOOLID = c.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZZXS_01_01_XSXX AS d ON a.XSXXID = d.ID /*学生ID*/ AND a.SCHOOLID = d.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_ZZXS_17_A01_TYXX AS e ON a.TYXXID = e.ID /*团员信息表ID*/ AND a.SCHOOLID = e.SCHOOLID /*学校*/ LEFT OUTER JOIN
      dbo.EDU_JY_XQ AS [cb] ON c.XQM = [cb].DM /*学期码*/ LEFT OUTER JOIN
      dbo.EDU_JY_SFZJLX AS [db] ON d.SFZJLXM = [db].DM /*身份证件类型码*/ LEFT OUTER JOIN
      dbo.EDU_GB_RDXB AS [dc] ON d.XBM = [dc].DM /*性别码*/ LEFT OUTER JOIN
      dbo.EDU_JY_XX AS [dd] ON d.XXM = [dd].DM /*血型码*/ LEFT OUTER JOIN
...
FROM dbo.EDU_ZZXS_18_A02_CFLX AS a LEFT OUTER JOIN
      ...
      dbo.EDU_JY_SFBZ AS d ON a.SFYXJC = d.DM /*是否允许解除*/
GO
